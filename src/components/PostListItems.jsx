        ...
        <div className="w-full ">
          ...
          <div className="lg:text-base xl:text-xl  text-lg font-semibold py-4 px-2 ">
            <h1>
              ...
              fugiat molestiae quaerat obcaecati fugit ullam ad iure. Doloribus
              debitis natus obcaecati eius dolorum molestias quibusdam itaque,
              amet nam quam illum.
            </h1>
          </div>
          {/* span items */}
          ...
          {/* description */}
          <div>
            <p className="p-2 lg:text-sm">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt
              nostrum voluptate iste! Illo modi illum consectetur aperiam
              incidunt, maiores nam minima, ratione corrupti aut nihil, dicta
              dolor numquam repellat perferendis.
            </p>
          </div>
          {/* read more  */}
